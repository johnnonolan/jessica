...
{
    public class before_filter_list
    {
        Establish context = () =>
            Filters = new BeforeFilters();

        protected static BeforeFilters Filters;
    }

    public class when_adding_two_before_filters_to_the_end : before_filter_list
    {
        Because of = () =>
        {
    ...
    public class when_adding_two_before_filters_to_the_start : before_filter_list
    {
        Because of = () =>
        {
    ...
    public class when_inserting_an_before_filter_at_index : before_filter_list
    {
        Because of = () =>
        {
            Filters.AddFilterToEnd(_filter1);
    ...
    public class when_concatenating_a_before_filter : before_filter_list
    {
        Because of = () =>
        {
            Filters.AddFilterToEnd(_filter2);
    ...
    public class when_invoking_before_filters_containing_two_filters : before_filter_list
    {
        Because of = () =>
        {
