...
** @string@ - Body
** @Action<Stream>@ - Writes to OutputStream
...
* Spark
** @Jessica.ViewEngine.Spark@ - Currently In Progress
* Razor
...
** Views directory - Directory containing views
** Public directory - Directory containing static files for helper responses
